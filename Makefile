...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/Thunar.spec.in \
	$(srcdir)/config.h.in $(top_srcdir)/configure AUTHORS COPYING \
	COPYING.LIB ChangeLog INSTALL NEWS THANKS TODO compile \
...
CONFIG_CLEAN_FILES = Thunar.spec
...
ACLOCAL = ${SHELL} /home/em/xyz/Thunar_sort_files_by_extension-master/missing --run aclocal-1.10
...
AMTAR = ${SHELL} /home/em/xyz/Thunar_sort_files_by_extension-master/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/em/xyz/Thunar_sort_files_by_extension-master/missing --run autoconf
AUTOHEADER = ${SHELL} /home/em/xyz/Thunar_sort_files_by_extension-master/missing --run autoheader
AUTOMAKE = ${SHELL} /home/em/xyz/Thunar_sort_files_by_extension-master/missing --run automake-1.10
AWK = gawk
CATALOGS =  ar.gmo be.gmo ca.gmo cs.gmo da.gmo de.gmo dz.gmo el.gmo en_GB.gmo eo.gmo es.gmo et.gmo eu.gmo fi.gmo fr.gmo gl.gmo he.gmo hu.gmo id.gmo it.gmo ja.gmo ka.gmo ko.gmo ku.gmo lt.gmo lv.gmo mk.gmo nb.gmo nl.gmo nn.gmo pa.gmo pl.gmo pt_BR.gmo pt.gmo ro.gmo ru.gmo sk.gmo sq.gmo sv.gmo tr.gmo uk.gmo ur.gmo zh_CN.gmo zh_TW.gmo
CATOBJEXT = .gmo
CC = gcc
...
EXIF_VERSION = 
EXO_CFLAGS = -I/usr/include/exo-0.3 -I/usr/include/gtk-2.0 -I/usr/include/xfce4 -I/usr/lib/gtk-2.0/include -I/usr/include/atk-1.0 -I/usr/include/cairo -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/freetype2 -I/usr/include/libpng12  
EXO_HAL_CFLAGS = -DDBUS_API_SUBJECT_TO_CHANGE -I/usr/include/exo-0.3 -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include -I/usr/include/hal -I/usr/include/dbus-1.0 -I/usr/lib/dbus-1.0/include  
EXO_HAL_LIBS = -L/lib -lexo-hal-0.3 -lglib-2.0 -lhal-storage -lhal -ldbus-1  
EXO_HAL_REQUIRED_VERSION = 0.3.1.13
EXO_HAL_VERSION = 0.3.105
EXO_LIBS = -lexo-0.3 -lgtk-x11-2.0 -lxfce4util -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lgdk_pixbuf-2.0 -lpangocairo-1.0 -lcairo -lpango-1.0 -lfreetype -lfontconfig -lgobject-2.0 -lgmodule-2.0 -lglib-2.0  
...
GDK_PIXBUF_LIBS = -lgdk_pixbuf-2.0 -lgobject-2.0 -lgmodule-2.0 -lglib-2.0  
GDK_PIXBUF_REQUIRED_VERSION = 2.10.0
GDK_PIXBUF_VERSION = 2.16.6
GETTEXT_PACKAGE = Thunar
GLIB_CFLAGS = -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include  
GLIB_LIBS = -lglib-2.0  
GLIB_REQUIRED_VERSION = 2.12.0
GLIB_VERSION = 2.20.5
GMOFILES =  ar.gmo be.gmo ca.gmo cs.gmo da.gmo de.gmo dz.gmo el.gmo en_GB.gmo eo.gmo es.gmo et.gmo eu.gmo fi.gmo fr.gmo gl.gmo he.gmo hu.gmo id.gmo it.gmo ja.gmo ka.gmo ko.gmo ku.gmo lt.gmo lv.gmo mk.gmo nb.gmo nl.gmo nn.gmo pa.gmo pl.gmo pt_BR.gmo pt.gmo ro.gmo ru.gmo sk.gmo sq.gmo sv.gmo tr.gmo uk.gmo ur.gmo zh_CN.gmo zh_TW.gmo
...
HAL_DBUS_CFLAGS = -I/usr/include/dbus-1.0 -I/usr/lib/dbus-1.0/include -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include  
HAL_DBUS_LIBS = -L/lib -ldbus-glib-1 -ldbus-1 -lgobject-2.0 -lglib-2.0  
HAL_DBUS_REQUIRED_VERSION = 0.23
HAL_DBUS_VERSION = 0.80
HAL_LIBS = -L/lib -lhal-storage -lhal -ldbus-1  
...
LIBFAM_CFLAGS =  
LIBFAM_LIBS = -lgamin-1  
LIBFAM_REQUIRED_VERSION = 0.1.0
LIBFAM_VERSION = 0.1.10
LIBJPEG_CFLAGS = 
...
LIBSTARTUP_NOTIFICATION_VERSION = 0.9
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/em/xyz/Thunar_sort_files_by_extension-master/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
PLATFORM_CFLAGS = 
PLATFORM_CPPFLAGS =  -DNDEBUG -DG_DISABLE_CAST_CHECKS -DHAVE_GNUC_VISIBILITY
PLATFORM_LDFLAGS =  -Wl,-O1
POFILES =  ar.po be.po ca.po cs.po da.po de.po dz.po el.po en_GB.po eo.po es.po et.po eu.po fi.po fr.po gl.po he.po hu.po id.po it.po ja.po ka.po ko.po ku.po lt.po lv.po mk.po nb.po nl.po nn.po pa.po pl.po pt_BR.po pt.po ro.po ru.po sk.po sq.po sv.po tr.po uk.po ur.po zh_CN.po zh_TW.po
POSUB = po
PO_IN_DATADIR_FALSE = 
PO_IN_DATADIR_TRUE = 
RANLIB = ranlib
...
SHELL = /bin/sh
STRIP = strip
TDB_U32_TYPE = unsigned int
THUNAR_VERINFO = 5:1:3
...
X_LIBS = 
X_PRE_LIBS =  -lSM -lICE
abs_builddir = /home/em/xyz/Thunar_sort_files_by_extension-master
abs_srcdir = /home/em/xyz/Thunar_sort_files_by_extension-master
abs_top_builddir = /home/em/xyz/Thunar_sort_files_by_extension-master
abs_top_srcdir = /home/em/xyz/Thunar_sort_files_by_extension-master
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = $(SHELL) /home/em/xyz/Thunar_sort_files_by_extension-master/install-sh
...
Thunar.spec: $(top_builddir)/config.status $(srcdir)/Thunar.spec.in
...
installdirs-am:
	for dir in "$(DESTDIR)$(libexecdir)" "$(DESTDIR)$(desktopdir)" "$(DESTDIR)$(servicedir)"; do \
...
install-data-am: install-desktopDATA install-serviceDATA
...
uninstall-am: uninstall-desktopDATA uninstall-libexecSCRIPTS \
	uninstall-serviceDATA
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	uninstall-desktopDATA uninstall-libexecSCRIPTS \
	uninstall-serviceDATA
